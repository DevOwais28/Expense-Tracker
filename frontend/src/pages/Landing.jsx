...
const HeroSection = ({ onGetStarted }) => (
  ...
  <section className="grid gap-10 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] md:items-center"><div className="space-y-6">
...
const HeroDashboardCard = () => (
  ...
  <div className="relative mx-auto w-full max-w-sm sm:max-w-md rounded-2xl sm:rounded-3xl bg-white/95 p-4 sm:p-5 text-slate-900 shadow-2xl shadow-slate-900/40 ring-1 ring-slate-200/80"><div className="mb-4 flex items-center justify-between">
...
const FooterSection = () => (
  ...
  <footer className="mt-6 rounded-2xl bg-slate-950/40 px-4 py-5 text-xs text-slate-300 ring-1 ring-white/10"><div className="grid gap-4 sm:grid-cols-4">
